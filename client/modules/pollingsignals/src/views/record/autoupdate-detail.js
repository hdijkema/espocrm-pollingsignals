...
define('pollingsignals:views/record/autoupdate-detail', 
   ['views/record/detail', 'pollingsignals:signals'], 
   function (Dep, Signals) {
      ...
      setup: function() {
               ...
               let topic = 'autoupdate';
               let signals = Signals;
               let me = this;
               signals.registerSignal(this,
                                      topic, this.model.entityType, this.model.id,
                                      function() { 
	                                 console.log('fetching: '+topic + '.' + me.model.entityType + '.' + me.model.id);
                                         me.model.fetch(); 
					 console.log('done. ');
                                      }
                                     );
